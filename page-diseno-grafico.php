              ...
              <article class="h-entry enunciado">
                ...
                <div class="e-content p-summary p-name carrera">
                  <div class='bloque' id="bloque_texto"><?php the_content(); ?>
                    ...
                    <div class="imagen-docente indice"><img class="ancho-maximo" src="<?php bloginfo('template_directory') ?>/img/silvia-arriagada.jpg" alt="" /></div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="pagina docente indice">
                    <div class="imagen-docente indice"><img class="ancho-maximo" src="<?php bloginfo('template_directory') ?>/img/jose-balcells.jpg" alt="" /></div>
                    <div class="datos-docente indice">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="pagina docente indice">
                    <div class="imagen-docente indice"><img class="ancho-maximo" src="<?php bloginfo('template_directory') ?>/img/katherine-exss" alt="" /></div>
                    <div class="datos-docente indice">
                    ...
                    <p>
                    Diseñador Gráfico; P.U. Católica de Valparaíso, Chile.
                    MA Information Design, University of Reading, Reino Unido.
                    </p>
                    </div>
                    </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="pagina docente indice">
                    <div class="imagen-docente indice"><img class="ancho-maximo" src="<?php bloginfo('template_directory') ?>/img/alejandro-garreton.jpg" alt="" /></div>
                    <div class="datos-docente indice">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="pagina docente indice">
                    <div class="imagen-docente indice"><img class="ancho-maximo" src="<?php bloginfo('template_directory') ?>/img/floro.jpg" alt="" /></div>
                    <div class="datos-docente indice">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="pagina docente indice">
                    <div class="imagen-docente indice"><img class="ancho-maximo" src="<?php bloginfo('template_directory') ?>/img/herbert-spencer.jpg" alt="" /></div>
                    <div class="datos-docente indice">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="pagina docente indice">
                    <div class="imagen-docente indice"><img class="ancho-maximo" src="<?php bloginfo('template_directory') ?>/img/michele-wilkomirsky.jpg" alt="" /></div>
                    <div class="datos-docente indice">
