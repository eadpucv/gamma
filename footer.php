...
<footer>
   ...
   <div class='wrap'>
        <div class='fila'>
            <div class='col-lg-4 col-md-8 col-sm-7 col-xs-12 escuela'>
            ...
            <!--<div class='col-lg-4 col-md-4'>
                ...
                <div class='sitio-relacionado'>
                    <p><a href='http://madlab.cl/'><i class="icn icn-engranaje icn-lg"></i>  Madlab</a></p>
                </div>
            </div>-->
            <div class='col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-0'>
              <p>e[ad] en las redes sociales</p>
        ...
        <div class='fila'>
          ...
          <!--<div class='col-lg-4 col-md-4 col-sm-8 col-xs-12 escuela'>
            <div class='licencia'>
          ...
          <div class='col-lg-4 col-md-4 col-sm-4 oculto-xs'>
              <div class='direccion'>
                <p>
                <a href='<?php echo get_permalink(43); ?>'><i class='icn icn-email icn-md'></i>Contacto</a><br> Matta 12, Recreo, Viña del Mar, Chile.
                <br>Cód. Postal: 2580129, Casilla 4170 V2 Valparaíso</p>
