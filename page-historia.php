                            ...
                            <article class="h-entry">
                                ...
                                <div class="e-content p-summary p-name">
                                    <div class='bloque'>
                                        ...
                                        <p>En 1984 la Escuela incluye en su Plan de Estudios la realización anual de Travesías por América. Ellas se organizan por Talleres en las que participan todos los alumnos y profesores.</p>
                                        <p>Ellas han llegado desde el Canal Beagle a la Isla de Pascua, el Amazonas, el Ecuador, las Pampas, la Selva. En las Travesías se llevan a cabo Actos y proclamaciones, culminan en leves obras de arquitectura y diseño que se donan a la gente del lugar.</p>
                                    </div>
                                </div>
                            </article> 
                        </div>
                                ...
                                <div class="e-content p-summary p-name">
                                    ...
                                    <div class='pagina docente historia'>
                                        ...
                                        <div class='datos-docente historia'>
                                            ...
                                            <h6 class='h-sin-margen'>Poeta y profesor universitario </h6>
                                            <h6>n. 1917 - † 2001</h6>
                                        </div>
                                        <div class='resena-docente historia'>
                                    ...
                                    <div class='pagina docente historia'>
                                        ...
                                        <div class='datos-docente historia'>
                                            ...
                                            <h6  class='h-sin-margen'>Arquitecto y profesor universitario</h6>
                                            <h6>n. 1927 - † 2001</h6>
                                        </div>
                                        <div class='resena-docente historia'>
